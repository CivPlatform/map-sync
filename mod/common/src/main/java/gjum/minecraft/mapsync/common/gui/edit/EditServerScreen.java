package gjum.minecraft.mapsync.common.gui.edit;
...
public class EditServerScreen extends Screen {
    ...
    public EditServerScreen(
            final @NotNull ServerListScreen previousScreen,
            final @NotNull String previousAddress
    ) {
        super(new TextComponent("Edit MapSync Server"));
        this.previousScreen = Objects.requireNonNull(previousScreen);
        this.previousAddress = Objects.requireNonNull(previousAddress);
    }
    ...
    protected void init() {
        ...
        if (this.alreadySetup) {
            ...
            this.addressInput.setValue(this.previousAddress);
        }
        ...
        addRenderableWidget(new Button(
                ...
                (button) -> {
                    ...
                    if (StringUtils.isBlank(serverAddress) || this.previousAddress.equals(serverAddress)) {
                        return;
                    }
                    ...
                    serverAddresses.removeIf((address) -> StringUtils.equals(address, this.previousAddress)); // remove duplicates too
