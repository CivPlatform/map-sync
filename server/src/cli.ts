...
const term = lib_readline.createInterface({ input: process.stdin, output: process.stdout }) as TermType;
...
if (!("MAPSYNC_DUMB_TERM" in process.env)) {
	...
	function fixStdoutFor(term: TermType) {
		...
		Object.defineProperty( process, "stdout", { get: function() { return newStdout; } });
		Object.defineProperty( process, "stderr", { get: function() { return newStderr; } });
	}
	fixStdoutFor(term);
